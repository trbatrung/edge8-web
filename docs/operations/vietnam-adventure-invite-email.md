# Vietnam Adventure — family sign-up invite email

**Status:** Draft for approval (not sent)
**Audience:** Everyone joining the Edge8 Vietnam trip + their families
**Form URL:** https://www.edge8.ai/vietnam-adventure-info-form

> Note: fill in the trip dates before sending. The passport-deletion promise on the
> form is "within 30 days of the trip ending" — make sure `TRIP_END_DATE` is set to match.
...
It takes about two minutes. You'll add:
