...
**Part One: The Empty Column** (complete)
...
**Part Four: Two Numbers and the Cost** (ch26 to ch32): ch26 (The hardest conversation) and ch31 (The board returns) drafted; ch27 to ch30 and ch32 not yet drafted.

## Continuity notes (established, do not contradict)

- Marcus's arc, explicit: lost to empowered, non-technical to tech-forward, AI as threat to AI as opportunity. His core identity: he sincerely believes Halden is people, product, and process, and never saw how AI helps a business built that way. He did not seek the AI spend; his peer group and the board pushed him into it 18 months ago and he gave in against his own instinct. He already privately knew, before ch1, that revenue and cost had both stayed flat (pulled the numbers himself in March) and that there was no way to claim ROI. This is planted in ch01 (Ellery's "revenue up or cost down, that is the whole scorecard") and ch03/ch04.
- Marcus's three self-authored questions (ch04, written after his own late-night research into an unbranded piece, not fed to him by Priya): who could actually run this, what workflows are documented, where does the truth of the company live. He carries the page in his shirt pocket through ch05 to ch07. They get progressively answered: ch07 answers "who" (nobody, no agents on the chart), ch09/10 answers "what's documented" (nothing, eleven of fourteen boxes are just waiting), ch13 answers "where's the info" (nine names and a whiteboard corner). Ch14 makes explicit that reading the words (from the article) was never the same as having the skill.
